...
const uint8_t our_report_descriptor[] = {
    // First Mouse Collection: Absolute positioning, no scrolling
    ...
    // Second Mouse Collection: Relative positioning, with scrolling
    0x05, 0x01,                         // Usage Page (Generic Desktop Ctrls)
    0x09, 0x02,                         // Usage (Mouse)
    0xA1, 0x01,                         // Collection (Application)
    0x05, 0x01,                         //   Usage Page (Generic Desktop Ctrls)
    0x09, 0x02,                         //   Usage (Mouse)
    0xA1, 0x02,                         //   Collection (Logical)
    0x85, REPORT_ID_MOUSE_RELATIVE,      //     Report ID (REPORT_ID_MOUSE_RELATIVE)
    0x09, 0x01,                         //     Usage (Pointer)
    0xA1, 0x00,                         //     Collection (Physical)
    0x05, 0x09,                         //       Usage Page (Button)
    0x19, 0x01,                         //       Usage Minimum (0x01)
    ...
    0x36, 0x00, 0xE0,                   //       Physical Minimum (-8192)
